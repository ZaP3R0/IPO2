...
namespace pokemon
{
    public sealed partial class Batalla1P : UserControl
    {
        Combate combate;
        ...
        public Batalla1P(Combate combatee, String pokemonn1, string pokemonn2)
        {
        ...
        private async void atacar1_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (gardevoir2.vidaTotal <= 0 || zapdos2.vidaTotal <= 0 || jigglypuff2.vidaTotal <= 0 || dragonite2.vidaTotal <= 0)
            {
                ...
                combate.abrirVictoria2(jugador1.Text, pokemon1, pokemon2,1);
            }
            else
            {
                desbloquearJugador2();
        ...
        private void sorteo()
        {
            ...
            switch (num)
            {
                case 1:
                    atacar2();
                    turnoJugador2.Text = "El " + pokemon2 + " enemigo ha decidido atacar";
                    break;
                case 2:
                    curar2();
                    turnoJugador2.Text = "El " + pokemon2 + " enemigo ha decidido curarse";
                    break;
                case 3:
                    subirAtaque2();
                    turnoJugador2.Text = "El " + pokemon2 + " enemigo ha decidido subirse el ataque";
                    break;
        ...
        {
            combate.abrirVictoria2(jugador2.Text, pokemon1, pokemon2, 1);
        }

        private void subirAtaque2()
        {
            bloquearJugador2();
